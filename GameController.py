...
class GameController:
    ...
    def first_word_insert_to_start(self):
        # class 'list'
        all_words_from_history = self._ai.return_all_words_from_database_no_duplicates_alphabetically()
        # class 'str'
        ...
        if self._web_controller.read_returned_text_for_first_try() == "I'm sorry, I don't know this word":
            ...
            self.first_word_insert_to_start()
        else:
